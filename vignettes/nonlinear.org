...
Measurements:
   y1~eta2           1.00000
   y2~eta2           0.97784  0.03460   28.25978   <1e-12
   y3~eta2           1.04516  0.03472   30.10240   <1e-12
Regressions:
   eta2~z            1.02615  0.22371    4.58699 4.497e-06
   eta2~eta1_1       3.54900  0.63734    5.56849 2.57e-08
   eta2~eta1_2      -0.06054  0.02462   -2.45885 0.01394
   eta2~eta1_3       0.05952  0.07251    0.82092 0.4117
Intercepts:
   y1                0.00000
   y2               -0.12178  0.10922   -1.11502 0.2648
   y3               -0.09873  0.10547   -0.93606 0.3492
   eta2              4.32762  1.45956    2.96501 0.003027
Residual Variances:
   y1                1.31538  0.17614    7.46772
   y2                1.10068  0.14566    7.55650
   y3                0.81251  0.13272    6.12200
   eta2              2.02944  0.29264    6.93490
#+end_example
...
#+NAME: estmixture
#+BEGIN_SRC R :cache t :exports code :ravel cache=TRUE,warnings=FALSE,messages=FALSE,eval=FALSE,cache.path="cache/"
  em0 <- NULL
  ll <- c()
  for (i in 1:5) {
      set.seed(i)
