...
```
or as a vector of perl-style regqular expressions 
```{r}
...
Let (Z_{1}, Z_)
\[
\sqrt{n}(\widehat{\theta}-\theta) = \frac{1}{\sqrt{N}}
\sum_{i=1}^{N} IC(Z_{i}; P) + o_{p}(1)
\]

\[
\frac{1}{\sqrt{N}}
\sum_{i=1}^{n} \sum_{k_{i}=1}^{N_{i}} IC(Z_{ik}; P)
\]
