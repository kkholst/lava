...
```{r  plotload, results="hide",message=FALSE,warning=FALSE }
library("lava")
...
As an example, we will simulate data from this model with a single covariate.
...
scale using the `summary` method.
