...
##' @param polygon.density if non-zero add shading lines
##' @param polygon.angle shading lines angle
...
##' @param ylab 
##' @param density.ylab y label for density plots
##' @param density.ylim y-axis limits for density plots
##' @param density.xlim x-axis limits for density plots
...
##' @param density.alpha semi-transparency of 
##' @param border 
##' @param density.lty 
##' @param density.col 
##' @param density.lwd 
